    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card card-default">
            ...
            <div class="card-body border-bottom">
              <form method="post" action="<?php echo site_url('stok/masuk') ?>">
        ...
        <div class="col-md-9">
          <div class="card card-default">
            <div class="card-header">
              <h5 class="card-title">Data Penambahan Stok</h5>
            </div>
            <div class="card-body">
...
<script>
  let read_url = '<?php echo site_url('stok/read/masuk') ?>'
  let hapus_url = '<?php echo site_url('stok/delete') ?>'
  let get_barang_url = '<?php echo site_url('barang/get_barang') ?>'
</script>
<script src="<?php echo base_url() ?>assets/js/stok_masuk.js"></script>
</body>
</html>
